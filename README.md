...
**[→ Latest release (2.3.2 · Rowan)](https://github.com/krwg/cultiva/releases/latest)**

| Platform | Artifact | Notes |
|----------|----------|--------|
| **Windows** | `Cultiva-Setup-2.3.2.exe` | NSIS installer — shortcuts, uninstall entry |
| **Windows** | `Cultiva-Portable-2.3.2.exe` | No install required |
| **macOS Intel** | `Cultiva-2.3.2-mac-x64.dmg` | Also `.zip` |
| **macOS Apple Silicon** | `Cultiva-2.3.2-mac-arm64.dmg` | Also `.zip` |
| **Linux** | `Cultiva-2.3.2-linux-x86_64.AppImage` | Single file, no root |
| **Linux** | `Cultiva-2.3.2-linux-amd64.deb` | Debian / Ubuntu |

**Release notes:** [2.3.2 Rowan](docs/release-notes-v2.3.2-rowan-github.md) · [2.3.1 Rowan](docs/release-notes-v2.3.1-rowan-github.md) · [2.3.0 Rowan](docs/release-notes-v2.3.0-rowan-github.md) · [2.2.0 Rowan](docs/release-notes-v2.2.0-rowan-github.md) · [2.1.3 Rowan](docs/release-notes-v2.1.3-rowan-github.md) · [2.0.0 Rowan](docs/release-notes-v2.0.0-rowan-github.md) · [1.7.0 Linden](docs/release-notes-v1.7.0-linden-github.md) · **[Full progress story](CultivaProgress.md)**
...
Install from **Settings → Plugins → Browse**. Requires Cultiva **≥ 2.0.0** (recommended **2.3.2+**) and registry **[3.5.7](https://github.com/krwg/cultiva-plugins/blob/main/registry.json)**.
...
Built with care by [krwg](https://github.com/krwg) · **GPL-3.0** · **2.3.2 · Rowan**
