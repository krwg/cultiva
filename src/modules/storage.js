      ...
      if (lsBundle) {
        try {
          ...
          if (parsed && typeof parsed === 'object') {
            const flatKeys = new Set(['lang', 'theme', 'showTrophies', 'showNextTreeProgress', 'showGardenHeatmap', 'focusMode', 'focusAutoStart', 'focusHideChrome', 'headerSearchEnabled', 'glyphSearchEnhanced', 'holidayRegion', 'avatar', 'pluginsEnabled', 'nativeNotifyEnabled', 'nativeNotifyHabits', 'nativeNotifyHabitsHour', 'nativeNotifyCalendar', 'nativeNotifyCalendarLeadMinutes', 'pluginNotifyMuted', 'checkUpdatesEnabled', 'autoUpdateEnabled', 'developerMode', 'devForceReducedMotion', 'devAnimBackground']);
