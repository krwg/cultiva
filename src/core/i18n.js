export const TRANSLATIONS = {
  ...
  ru: {
    ...
    onboardingHabitTitle: 'Посадите первую привычку',
    onboardingHabitLead: 'Необязательно — можно добавить позже.',
    onboardingHabitPlaceholder: 'например, Утренняя прогулка',
    onboardingBackupTitle: 'Локальные копии',
    onboardingBackupLead: 'Cultiva может тихо сохранять ZIP-снимки на этом устройстве — без облака.',
