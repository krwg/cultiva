...
export const MATERIAL = {
  ...
  centerFocus: materialIcon('M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm-7 7H3v4c0 1.1.9 2 2 2h4v-2H5v-4zM5 5h4V3H5c-1.1 0-2 .9-2 2v4h2V5zm14-2h-4v2h4v4h2V5c0-1.1-.9-2-2-2zm0 16h-4v2h4c1.1 0 2-.9 2-2v-4h-2v4z'),
  tree: materialIcon('M17 12h2L12 2 5.05 12H7l-3.9 6h6.92v4h3.96v-4H21l-4-6z')
};
...
export const SETTINGS_SIDEBAR_ICONS = {
  ...
  focus: MATERIAL.centerFocus,
  garden: MATERIAL.tree,
